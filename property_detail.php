...
<body>
    ...
    <div class="property-summary page-container">
        ...
        <div class="row no-gutters">
            ...
            <a class="btn btn-primary" href="#" data-toggle="modal" <?php if(isset($_SESSION['user_id']))
            {
                ?>data-target="#booknow-modal"<?php }
                else{ ?>data-target="#login-modal"<?php }?>>
                            Book Now
                        </a>
            <div class="modal fade" id="booknow-modal" tabindex="-1" role="dialog" aria-labelledby="signup-heading" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="signup-heading">Bookings@PGLife</h5>
                ...
                <h3>BOOKING REQUEST SUCCESSFULLY SENT TO PG OWNER!</h3>
    <br><h3>THANK YOU FOR CONSIDERING PG Life FOR YOUR PG SEARCH. PLEASE SHARE OUR WEBSITE WITH YOUR FRIENDS IN NEED.</h3>
                </div>
